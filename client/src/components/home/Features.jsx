...
const Features = () => {
  ...
  return (
    <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
      ...
      <div className="flex flex-col md:flex-row items-center xl:-mt-10 mt-10">
        <img
        ...
        >
          ...
          <div className="flex items-center justify-center max-w-md group cursor-pointer">
            <div className={`p-6 flex gap-4 rounded-xl transition-colors border ${!isHover ? 'border-violet-300 bg-violet-100' : 'border-transparent group-hover:bg-violet-100 group-hover:border-violet-300'}`}>
